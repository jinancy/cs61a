def make_counter():
    ...
    def counter(count_str):
    	if count_str in dict_str:
    		dict_str[count_str] += 1
    	else:
    		dict_str[count_str] = 1
    	return dict_str[count_str]
    return counter
...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, password_attempt):
    	nonlocal lst_attempts
    	nonlocal balance
    	if len(lst_attempts) >= 3:
    		return "Your account is locked. Attempts: " + str(lst_attempts)
...
def make_joint(withdraw, old_password, new_password):
    ...
    if type(check) == str:
    	return check
    def withdraw_1(amount, password_attempt):
