...
(define (foo a b c d e f g) 1)
; expect foo

(foo 1 2 3 4 5 6 7)
; expect 1

(define my-fav-number 420.69)
; expect my-fav-number
...
(let ((x 100) (y 101)) x y 'return-last)
; expect return-last

(let ((x (lambda (a b) (- a b))) (y 100) (z 101)) (x y z))
; expect -1

(define f (mu () (- a b)))
; expect f

(define g (lambda (y) (define a 489) (define b 69) (f)))
; expect g
